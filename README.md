...
> 使用起来不需要复杂的角色卡，作者本人使用的时候角色卡经常只有不到1000字，用来设定简易的世界观和背景，并且连世界书都没开过。
> 不仅如此，得益于优秀的提示词设计，它非常节约tokens，平均30分钟的游玩过程总消费10-20万的tokens，换句话说，它使用起来十分便宜（30分钟，0.1元左右的消费），而且支持本地模型使用。
