...
CinemaWorld 是一个为 SillyTavern 设计的沉浸式视觉小说 / RPG 世界引擎扩展。它把聊天 AI 变成一个真正的"游戏主持人（GM）"，你不再只是和 AI 对话，而是在一个由 AI 动态生成、持续演化的世界里探索、战斗、经营、社交。不仅如此，得益于优秀的提示词设计，它非常节约tokens，平均30分钟的游玩过程总消费10-20万的tokens，换句话说，它使用起来十分便宜（30分钟，0.1元左右的消费），而且支持本地模型使用。
